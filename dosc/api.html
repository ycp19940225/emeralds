...
<div id="收藏-获取用户收藏" class="resource"><h3 class="resource-heading">获取用户收藏 <a href="#收藏-获取用户收藏" class="permalink">&nbsp;&para;</a></h3><div id="收藏-获取用户收藏-get" class="action get"><h4 class="action-heading"><div class="name">获取用户收藏</div><a href="#收藏-获取用户收藏-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/users/history?token={token}</code></h4><p>[获取数据为数组，goods为浏览的商品信息，articles为浏览的文章信息。如果goods为null,这条收藏应该归档于文章]</p>
<h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/users/history?token=<span class="hljs-attribute" title="token">token</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>token</dt><dd><code>varchar</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>密钥</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-string">"200"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="收藏-记录浏览历史" class="resource"><h3 class="resource-heading">记录浏览历史 <a href="#收藏-记录浏览历史" class="permalink">&nbsp;&para;</a></h3><div id="收藏-记录浏览历史-get" class="action get"><h4 class="action-heading"><div class="name">记录浏览历史</div><a href="#收藏-记录浏览历史-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/users/history/add?token={token}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/users/history/add?token=<span class="hljs-attribute" title="token">token</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>token</dt><dd><code>varchar</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>密钥</p>
</dd><dt>goods_id</dt><dd><code>int</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>商品ID</p>
</dd><dt>article_id</dt><dd><code>int</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>文章ID</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 12 Mar 2018</p><script>/* eslint-env browser */
