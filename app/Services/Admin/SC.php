...
class SC
{
    const LOGIN_MARK_SESSION_KEY = 'EMERALD_ADMIN_LOGIN_MARK';
    /**
     * 设置用户权限的key
     */
    CONST USER_ACL_SESSION_KEY = 'EMERALD_ADMIN_ACL_SESSION';

    /**
     * 所有的权限的key
    */
    CONST ALL_PERMISSION_KEY = 'EMERALD_ADMIN_PERMISSION_KEY';
    ...
    {
        session()->put('EMERALD_ADMIN_ACL_SESSION',$access);
    }
    ...
    {
        return session()->get('EMERALD_ADMIN_ACL_SESSION');
    }
