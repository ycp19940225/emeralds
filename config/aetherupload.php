...
return [
    ...
    "UPLOAD_PATH"         => storage_path() . DIRECTORY_SEPARATOR . "app" . DIRECTORY_SEPARATOR .  "public" .DIRECTORY_SEPARATOR."aetherupload", # 上传目录的本地物理路径
    "HEAD_DIR"            => "_head", # 指针头文件目录的名称，建议保持默认
    "FILE_SUB_DIR"        => @date("Y-m", time()), #资源文件目录的子目录生成规则，变量或常量均可
