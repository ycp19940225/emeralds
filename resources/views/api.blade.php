...
<h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/agent/goods</span></div><div class="title"><strong>Request</strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[]</code></pre><div style="height: 1px;"></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="用户代理商-手机验证码" class="resource"><h3 class="resource-heading">手机验证码 <a href="#用户代理商-手机验证码" class="permalink">&nbsp;&para;</a></h3><div id="用户代理商-手机验证码-get" class="action get"><h4 class="action-heading"><div class="name">手机验证码</div><a href="#用户代理商-手机验证码-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/users/sendSms?telphone=18983663382</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/users/sendSms?telphone=18983663382</span></div><div class="title"><strong>Request</strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>[]</code></pre><div style="height: 1px;"></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">200</span></span>,
  "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"短信验证码发送成功！"</span></span>,
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
    "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">200</span></span>,
    "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"短信验证码发送成功！"</span></span>,
  ...
  "<span class="hljs-attribute">error</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"false"</span></span>,
    "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-number">500</span></span>,
    "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"短信验证码发送失败！"</span></span>,
    "<span class="hljs-attribute">data</span>": <span class="hljs-value"><span class="hljs-string">""</span>
  </span>}
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="商品-编辑商品" class="resource"><h3 class="resource-heading">编辑商品 <a href="#商品-编辑商品" class="permalink">&nbsp;&para;</a></h3><div id="商品-编辑商品-post" class="action post"><h4 class="action-heading"><div class="name">编辑商品</div><a href="#商品-编辑商品-post" class="method post">POST</a><code class="uri">/http:/temp.cqquality.com/api/admin(agent)/goods/add?token=</code></h4><p>[<a href="http://temp.cqquality.com/api/admin/goods/edit,%E4%B8%BA%E7%AE%A1%E7%90%86%E5%91%98%E7%BC%96%E8%BE%91%E8%B7%AF%E5%BE%84">http://temp.cqquality.com/api/admin/goods/edit,为管理员编辑路径</a>]
[<a href="http://temp.cqquality.com/api/agent/goods/edit,%E4%B8%BA%E4%BB%A3%E7%90%86%E5%95%86%E7%BC%96%E8%BE%91%E8%B7%AF%E5%BE%84">http://temp.cqquality.com/api/agent/goods/edit,为代理商编辑路径</a>]</p>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="文章-获取分类文章（通过分类id）" class="resource"><h3 class="resource-heading">获取分类文章（通过分类ID） <a href="#文章-获取分类文章（通过分类id）" class="permalink">&nbsp;&para;</a></h3><div id="文章-获取分类文章（通过分类id）-get" class="action get"><h4 class="action-heading"><div class="name">获取分类文章（通过分类ID）</div><a href="#文章-获取分类文章（通过分类id）-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/articles/cat/id</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/articles/cat/id</span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>id</dt><dd><code>int</code>&nbsp;<span>(optional)</span>&nbsp;<p>分类ID</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-string">"200"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="轮播图-获取视频" class="resource"><h3 class="resource-heading">获取视频 <a href="#轮播图-获取视频" class="permalink">&nbsp;&para;</a></h3><div id="轮播图-获取视频-get" class="action get"><h4 class="action-heading"><div class="name">获取视频</div><a href="#轮播图-获取视频-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/video</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/video</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-string">"200"</span></span>,
  "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"获取成功！"</span></span>,
  "<span class="hljs-attribute">data</span>": <span class="hljs-value"><span class="hljs-string">""</span>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="优惠券" class="resource-group"><h2 class="group-heading">优惠券 <a href="#优惠券" class="permalink">&para;</a></h2><p>优惠券</p>
<div id="优惠券-获取所有优惠券" class="resource"><h3 class="resource-heading">获取所有优惠券 <a href="#优惠券-获取所有优惠券" class="permalink">&nbsp;&para;</a></h3><div id="优惠券-获取所有优惠券-get" class="action get"><h4 class="action-heading"><div class="name">获取所有优惠券</div><a href="#优惠券-获取所有优惠券-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/coupons</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/coupons</span></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-string">"200"</span></span>,
  "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"获取成功！"</span></span>,
  "<span class="hljs-attribute">data</span>": <span class="hljs-value"><span class="hljs-string">""</span>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="客服" class="resource-group"><h2 class="group-heading">客服 <a href="#客服" class="permalink">&para;</a></h2><p>客服</p>
<div id="客服-获取客服列表" class="resource"><h3 class="resource-heading">获取客服列表 <a href="#客服-获取客服列表" class="permalink">&nbsp;&para;</a></h3><div id="客服-获取客服列表-get" class="action get"><h4 class="action-heading"><div class="name">获取客服列表</div><a href="#客服-获取客服列表-get" class="method get">GET</a><code class="uri">/http:/temp.cqquality.com/api/chat/admin?token={token}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/http:/temp.cqquality.com/api/chat/admin?token=<span class="hljs-attribute" title="token">token</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>token</dt><dd><code>varchar</code>&nbsp;<span class="required">(required)</span>&nbsp;<p>密钥</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"true"</span></span>,
  "<span class="hljs-attribute">code</span>": <span class="hljs-value"><span class="hljs-string">"200"</span></span>,
  "<span class="hljs-attribute">msg</span>": <span class="hljs-value"><span class="hljs-string">"获取成功！"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 02 May 2018</p><script>/* eslint-env browser */
