...
[ [POST /http://temp.cqquality.com/api/goods/search/type]
 @Parameter(<span class="hljs-string">"cat_id"</span>, type=<span class="hljs-string">"varchar"</span>, required=<span class="hljs-literal">true</span>, description=<span class="hljs-string">"一级品种ID"</span>),</code></pre><div style="height: 1px;"></div></div></div><div class="title"><strong>Request</strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">cat_id</span>": <span class="hljs-value"><span class="hljs-string">"114"</span></span>,
