                    ...
                    <div class="table-responsive">
                        ...
                        <table id="data-table" class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $v['updated_at'] }}</td>
                                <td>
                                    <a class="btn btn-success btn-xs m-2 detail" href="{{ url('admin/slide/edit',['id'=>$v['id']]) }}" >编辑</a>
    ...
    <script>
        ...
        function del(i) {
            ...
            layer.confirm('是否删除？', {
                ...
                $.post("{{ url('admin/slide/delete') }}",data,function (res) {
                    console.log(res);
                    if(res['code'] === 'success'){
                        layer.msg(res['msg'],{icon: 6});
                        setTimeout('location.href="{{ url('admin/slide/index') }}"',1000);
                    }else{
