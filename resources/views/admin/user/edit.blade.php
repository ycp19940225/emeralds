                        ...
                        <form action="" class="form-horizontal form_need_validate" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" value="0" id="optionsRadios0" name="type" {{ $data['checked_0'] or ''}}>普通用户
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio"  value="1" id="optionsRadios1" name="type" {{ $data['checked_1'] or ''}}>管理员客服
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio"  value="2" id="optionsRadios2" name="type" {{ $data['checked_2'] or ''}}>代理商
                                        </label>
                                    </div>
                                </div>
                            </div>
